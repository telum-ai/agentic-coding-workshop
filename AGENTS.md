...
## Schema changes
No Alembic. After editing `backend/app/models.py`, run `rm -f sandbox.db` — next boot recreates schema from models. Skip this and you'll hit "no such column/table" at request time.
